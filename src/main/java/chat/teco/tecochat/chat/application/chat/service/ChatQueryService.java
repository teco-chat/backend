...
import static chat.teco.tecochat.chat.application.chat.mapper.ChatMapper.mapToQueryResponse;
import static chat.teco.tecochat.chat.application.chat.mapper.ChatMapper.mapToSearchQueryResponse;
...
public class ChatQueryService implements QueryChatByIdUseCase, SearchChatUseCase {
    ...
    public Page<SearchChatResponse> search(ChatSearchCond cond, Pageable pageable) {
        Page<Chat> result = chatQueryRepository.search(cond, pageable);
