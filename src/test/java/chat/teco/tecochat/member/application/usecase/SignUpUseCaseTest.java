...
@DisplayName("SignUpUseCase(회원가입) 은(는)")
class SignUpUseCaseTest {

    private final MemberRepository memberRepository = mock(MemberRepository.class);
    private final SignUpUseCase signUpUseCase = new MemberService(memberRepository);
    ...
    void 이미_이름이_존재하는_경우_코스를_변경한다() {
        ...
        // when
        signUpUseCase.signUp(new SignUpCommand(말랑.이름, FRONTEND));
